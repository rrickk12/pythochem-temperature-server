...
class SensorService:
    """
    @description:
        Provides a service layer to interact with sensor data.
        This layer abstracts the underlying database operations.
    """
    ...
    def update_sensor_alert_policy(self, mac, temp_min=None, temp_max=None, humidity_min=None, humidity_max=None):
        ...
        return {"status": "Alarm policy updated", "mac": mac}
...
# Create a singleton instance for easy use in other modules:
